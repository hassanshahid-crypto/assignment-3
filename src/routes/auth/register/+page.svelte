		...
		<div class="bg-[#202124] rounded-2xl border border-[#2a2b2e] p-8 sm:p-10">
			<div class="text-center mb-8">
				...
				<p class="mt-2 text-sm text-gray-400">
					...
					<a href="/auth/login" class="font-semibold text-emerald-400 hover:text-emerald-300 transition-colors">Sign in</a>
				</p>
			</div>
			...
			<div class="relative my-7">
				...
				<div class="relative flex justify-center text-sm">
					<span class="bg-[#202124] px-3 text-gray-500">or sign up with</span>
				</div>
			</div>
